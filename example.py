# This code was extracted from the p5 library (https://pypi.org/project/p5/).
# Renderer was set to "skia" for better 2D experience.
...
run(renderer="skia")  # "skia" is still in beta
